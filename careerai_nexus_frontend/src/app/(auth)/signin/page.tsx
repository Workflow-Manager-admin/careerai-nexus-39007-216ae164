...
// Colors for theme: pitch black & cyan (dark), white & pink (light)
const googleIcon = (
  <svg
    aria-hidden="true"
    focusable="false"
...
export default function SignInPage() {
  /** Renders the sign-in UI, handles credential/Google flows, error+redirect logic */
  ...
  // Colors: Pitch black & cyan (dark), white & pink (light mode)
  return (
